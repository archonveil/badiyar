const translations = {
    ru: {
        ...
        cta_book: 'ЗАПИСАТЬСЯ',
        hero_kicker: 'Dr. Искендеров Бадияр • Стоматолог',
        hero_line1: 'Ваша улыбка —',
        hero_line2: '<span class="hero__accent">моя</span> забота.',
        hero_subtitle: 'Уже более 15 лет я помогаю пациентам обрести здоровую и красивую улыбку. Индивидуальный подход, современные технологии, безболезненное лечение.',
        ...
        service4_text: 'Восстанавливаю зубы с помощью современных имплантов премиум-класса.',
    ...
    kg: {
        ...
        cta_book: 'ЖАЗЫЛУУ',
        hero_kicker: 'Dr. Искендеров Бадияр • Тиш дарыгери',
        hero_line1: 'Сиздин жылмаюуңуз —',
        hero_line2: '<span class="hero__accent">менин</span> камкордугум.',
        hero_subtitle: '15 жылдан ашуун убакыттан бери бейтаптарга дени сак, сулуу жылмаюуну тартуулап келем. Жеке мамиле, заманбап технологиялар, оорутпай дарылоо.',
        ...
        service4_title: 'Имплантация',
        service4_text: 'Премиум-класстагы заманбап импланттар менен тиштерди калыбына келтирем.',
        service5_title: 'Ортодонтия',
